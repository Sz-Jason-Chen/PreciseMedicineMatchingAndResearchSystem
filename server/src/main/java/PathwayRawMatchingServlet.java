...
@WebServlet("/PathwayRawMatchingServlet")
@MultipartConfig
public class PathwayRawMatchingServlet extends HttpServlet{
    public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException,IOException{
        ...
        resp.getWriter().write("<h4>test message: file read and variant point extract<br/></h4>");
        ...
        while (itr5.hasNext()) {
            ...
            ArrayList<HashMap> pathways = PathwayQuery.getPathwayByGene(gSymbol);

            if (pathways.size() != 0) {
                for (HashMap<String, String> pathway:pathways){
                    //resp.getWriter().write("Gene symbol:");
                    resp.getWriter().write(gSymbol);
